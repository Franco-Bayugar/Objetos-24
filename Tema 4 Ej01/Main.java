...
public class Main {
    public static void main(String[] args) {
        Cuadrado unCuadrado = new Cuadrado(20, "Verde", "Negro");
        Circulo unCirculo = new Circulo(10, "Azul", "Negro");
        Rectangulo unRectangulo = new Rectangulo(5, 10, "Dorado", "Rojo");
        Triangulo unTriangulo = new Triangulo(5, 5, 5, "Rojo", "Negro");
        
        System.out.println("Cuadrado: " + unCuadrado.toString());
        System.out.println("Circulo: " + unCirculo.toString());
        System.out.println("Rectangulo: " + unRectangulo.toString());
        System.out.println("Triangulo: " + unTriangulo.toString());
        
        unCuadrado.Despintar();
        unCirculo.Despintar();
        unRectangulo.Despintar();
